...
<div class="header">
    <div id="logo">
      <a style="padding: 10px; margin-right: 40px; background-color:#1E90FF;color:white;text-decoration: none; border-radius: 5px; float: left;" href="stayfit.php">Continue to Stay Fit Information page</a>
</div>
    </div><br/><br/>
 <a style="padding: 10px; margin-right: 40px; background-color:#3CB371;color:white;text-decoration: none; border-radius: 5px; float: left;" href="stayfit.php">Go back</a>
 </div><br/>
